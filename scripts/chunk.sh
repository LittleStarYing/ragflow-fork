curl 'http://localhost:9222/v1/chunk/list' \
  ...
  -H 'Referer: http://localhost:9222/knowledge/dataset/chunk?id=34178e2af8e411ef98a8c7b8a62886b7&doc_id=ea97fc28f90411ef98a8c7b8a62886b7' \
  ...
  --data-raw '{"doc_id":"ea97fc28f90411ef98a8c7b8a62886b7","page":1,"size":10,"keywords":""}'