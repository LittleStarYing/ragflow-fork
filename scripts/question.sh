curl 'http://localhost:9222/v1/chunk/retrieval_test' \
  ...
  --data-raw '{"similarity_threshold":0.2,"vector_similarity_weight":0.30000000000000004,"use_kg":false,"question":"grafana","doc_ids":[],"kb_id":"34178e2af8e411ef98a8c7b8a62886b7","page":1,"size":10}'